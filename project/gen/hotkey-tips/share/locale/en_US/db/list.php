...
*/
	...
	$item = array();
	$item['Keybind'] = "Alt + Shift + l";
	$item['Action'] = "Lock Screen";
	$list[] = $item;

/*
	$item = array();
	$item['Keybind'] = "Alt + Shift + c";
	$item['Action'] = "Popos Cosmic Reload";
	$list[] = $item;
*/
...
/*
	...
	$item['Action'] = "Popos Cosmic Restart";
	$list[] = $item;
*/
...
*/
	...
	$item['Action'] = "Launch File Manager (cosmic-files)";
	$list[] = $item;
	...
	$item['Action'] = "Launch Text Editor (cosmic-edit)";
	$list[] = $item;
	...
	$item['Action'] = "Launch System Setting (cosmic-settings)";
	$list[] = $item;
...
*/
	...
	$item['Action'] = "Launch Terminal (cosmic-term)";
	$list[] = $item;
	...
	$item['Action'] = "Launch Terminal (lxterminal)";
	$list[] = $item;
