...
/*
	...
	$item['Action'] = "Popos Cosmic 重新載入設定";
	$list[] = $item;
*/
...
*/
	...
	$item['Action'] = "開啟檔案管理器 (cosmic-files)";
	$list[] = $item;
	...
	$item['Action'] = "開啟系統設定 (cosmic-settings)";
	$list[] = $item;
...
*/
	...
	$item['Action'] = "開啟 Terminal (cosmic-term)";
	$list[] = $item;
	...
	$item['Action'] = "開啟 Terminal (lxterminal)";
	$list[] = $item;
