...
"Alt + Shift + l" "鎖定螢幕" "#ffffff" "Monospace 16" \
"Alt + F1" "開啟主選單" "#cccccc" "Monospace 16" \
"Alt + F2" "開啟應用程式啟動器" "#ffffff" "Monospace 16" \
"Alt + Shift + f" "開啟檔案管理器 (cosmic-files)" "#cccccc" "Monospace 16" \
"Alt + Shift + g" "開啟檔案管理器 (thunar)" "#ffffff" "Monospace 16" \
"Alt + Shift + e" "開啟 (cosmic-edit)" "#cccccc" "Monospace 16" \
"Alt + Shift + b" "開啟網頁瀏覽器 (firefox)" "#ffffff" "Monospace 16" \
"Alt + Shift + s" "開啟系統設定 (cosmic-settings)" "#cccccc" "Monospace 16" \
"Alt + Enter" "開啟 Terminal (cosmic-term)" "#ffffff" "Monospace 16" \
"Alt + Shift + a" "開啟 Terminal (cosmic-term)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + a" "開啟 Terminal (xfce4-terminal)" "#ffffff" "Monospace 16" \
"Alt + Shift + t" "開啟 Terminal (qterminal)" "#cccccc" "Monospace 16" \
"Alt + Ctrl + t" "開啟 Terminal (lxterminal)" "#ffffff" "Monospace 16" \
